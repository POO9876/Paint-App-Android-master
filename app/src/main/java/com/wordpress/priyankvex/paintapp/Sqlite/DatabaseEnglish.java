...
public class DatabaseEnglish extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databaseletterenglish";

    // Table Name
    private static final String TABLE_NAME = "tableletterenglish";



	public DatabaseEnglish(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
		// TODO Auto-generated constructor stub
	}
	    public static final String COLUMN_ID ="code";
	    public static final String COL_username_ = "username";
	    public static final String COL_letter_english = "letterenglish";
	    public static final String COL_point_english = "pointenglish";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE "+ TABLE_NAME +" (code INTEGER PRIMARY KEY AUTOINCREMENT, "
				...
				+ COL_letter_english + " TEXT(100), "
        		+ COL_point_english + " TEXT(100));");
	...
	//Insert data
		public long InsertData(String Code, String Ponit_uername, String Ponit_letter_thai, String Ponit_thai
			...
			Val.put(COL_letter_english, Ponit_letter_thai);
			Val.put(COL_point_english, Ponit_thai);
				 	...
				 	if(cursor != null)
				 	{
				 	    if (cursor.moveToFirst()) {
				 	        do {
					 	        ...
					 	        map.put(COL_letter_english, cursor.getString(2));
					 	        map.put(COL_point_english, cursor.getString(3));
		...
		public long UpdateData(String Code, String username, String letterThai ,String pointThai) {
			// TODO Auto-generated method stub
			 try {
				...
				Val.put(COL_letter_english, letterThai);
				Val.put(COL_point_english, pointThai);
		...
		public Cursor readAllDATA() {
			...
			Cursor mCursor = db.query(TABLE_NAME, new String[] {
					COLUMN_ID, COL_username_, COL_letter_english, COL_point_english}, null, null, null,
					null, null);
			if (mCursor != null) {
				mCursor.moveToFirst();
					}
