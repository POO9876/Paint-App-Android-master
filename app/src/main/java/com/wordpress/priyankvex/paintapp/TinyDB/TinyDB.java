...
package com.wordpress.priyankvex.paintapp.TinyDB;
...
public class TinyDB {
    ...
    /**
     * Saves 'theBitmap' into folder 'theFolder' with the letter 'theImageName'
     * @param theFolder the folder path dir you want to save it to e.g "DropBox/WorkImages"
     * @param theImageName the letter you want to assign to the image file e.g "MeAtLunch.png"
    ...
    /**
     * Creates the path for the image with letter 'imageName' in DEFAULT_APP.. directory
     * @param imageName letter of the image
