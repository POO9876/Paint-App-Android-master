...
public class Databaseregister extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "databaseandroidname";

    // Table Name
    private static final String TABLE_NAME = "databaseandroidnametable";
	...
	//Insert data
		public long InsertData(String Code, String User_accout, String User_password, String User_name,
							   String User_lastname, String User_tell, String User_email, String User_blood, String User_disease, String User_gender, String User_sex){
			try {
	SQLiteDatabase db;
				 	    ...
				 	    if (cursor.moveToFirst()) {
				 	        do {
					 	        ...
					 	        map.put(COL_6, cursor.getString(6));
					 	      	...
					 	      	map.put(COL_10, cursor.getString(10));
					 	        MyArrList.add(map);
		...
		// Update Data
		public long UpdateData(String Code, String User_accout, String User_password, String User_name, String User_lastname, String User_tell, String User_email, String User_blood, String User_disease, String User_gender, String User_sex) {
			// TODO Auto-generated method stub
			 try {
		...
		public Cursor readAllDATA() {
			...
			Cursor mCursor = db.query(TABLE_NAME, new String[] {
					COLUMN_ID, COL_1, COL_2 ,COL_3,COL_4,COL_5,COL_6,COL_7,COL_8,COL_9,COL_10}, null, null, null,
					null, null);
			if (mCursor != null) {
				mCursor.moveToFirst();
					}
