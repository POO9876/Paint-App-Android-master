...
public class Databasepointin extends SQLiteOpenHelper {
	
    // Database Version
    private static final int DATABASE_VERSION = 1;
 
    // Database Name
    private static final String DATABASE_NAME = "databasepointintdatabaetest";
 
    // Table Name
    private static final String TABLE_NAME = "databasepointintdatabaetesttable";

	public Databasepointin(Context context) {
